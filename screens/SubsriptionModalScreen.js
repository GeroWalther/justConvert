...
const SubsriptionModalScreen = ({ navigation }) => {
  return (
    <ScrollView className='bg-slate-700'>
      ...
      <Text className='text-sm text-slate-400 p-3'>
        * By clicking 'Subscribe & Pay' you agree to the terms our of conditions
        and subscribe to a monthly/yearly subcription
      </Text>
    </ScrollView>
  );
};
